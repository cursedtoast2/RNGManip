...
export default function SidebarFooter() {
  return (
    <footer className="site-sidebar-footer">
      <p>
        Thanks to {CREDITS.map((credit, index) => <span key={credit.href}><a href={credit.href} target="_blank" rel="noreferrer noopener">{credit.label}</a>{index < CREDITS.length - 1 ? ", " : "."}</span>)}
      </p>
      <p>
        Built by <a href="https://x.com/cursedtoastsda" target="_blank" rel="noreferrer noopener">CursedToast</a> ·{" "}
